...
from layouts import AMM_INFO_LAYOUT_V4_1
from layouts import MARKET_LAYOUT
from constants import RAY_AUTHORITY_V4, RAY_V4_AMM_ID, WSOL
    ...
    try:
        ...
        try:
            ...
            if pool_keys['base_mint'] == WSOL:
                ...
                pool_keys['quote_decimals'], pool_keys['base_decimals'] = pool_keys['base_decimals'], pool_keys[
                    'quote_decimals']
