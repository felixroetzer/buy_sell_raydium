...
# File Imports
from constants import LAMPORTS_PER_SOL, WSOL
...
def buy(solana_client, mint: Pubkey, payer: Keypair, amount: float, pool_keys: dict = None, GAS_LIMIT: int = 200_337,
        GAS_PRICE: int = 25_232, slippage: int = 100):
    for _ in range(3):
        ...
        try:
            ...
            instructions_swap = make_swap_instruction(solana_client, amount_in, WSOL_token_account,
                                                      swap_associated_token_address, pool_keys, mint, payer)
...
def sell(solana_client, mint: Pubkey, payer: Keypair, amount: float, pool_keys: dict = None, GAS_LIMIT: int = 200_337,
         GAS_PRICE: int = 25_232, slippage: int = 100):
    for _ in range(3):
        ...
        try:
            ...
            instructions_swap = make_swap_instruction(solana_client, amount_in, swap_token_account, WSOL_token_account,
                                                      pool_keys, mint, payer)
