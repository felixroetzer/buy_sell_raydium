...
from constants import RAY_V4_AMM_ID as AMM_PROGRAM_ID
from constants import OPEN_BOOK_PROGRAM as SERUM_PROGRAM_ID
from layouts import SWAP_LAYOUT


def make_swap_instruction(client, amount_in: int, token_account_in: Pubkey, token_account_out: Pubkey, accounts: dict,
                          mint: Pubkey, owner: Pubkey) -> Instruction:
